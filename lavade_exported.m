...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%  
    ...
    properties (Access = public)
        ...
        r2_train; 
        r2_test; 
        % Necessary for creating subplots in the panel section
        ax1;
        ax2;
    ...
    function init(app)
        ...
        function [Z, mx, stdx] = normalize_train(~, X)
            ...
            % does not return mean and std. Furthermore, nomrlaize in 2019b
        ...
        function Z = normalize_test(~, X, mx, stdx)
            ...
            % data stats.
            % Base don syntax from Matlab 'ridge' function. 
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            Z = (X-mx)./stdx;
        ...
        function b = ridge_regression(~, y, X, k)
            ...
            % This function is largely identical with matlbs ridge
            % implmentation, except that the standardization was removed. 
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        function plot_figures(app, y_test, y_pred, y_pred_train, coeff)
            ...
            app.r2_train = R_squared(app, y_pred_train, app.y_train);
            ...
            app.r2_test = R_squared(app, y_pred, y_test);
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ExperimentsEditField.Limits = [2 10000];
